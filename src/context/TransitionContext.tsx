...
export type ViewState = 'login' | 'transition' | 'dashboard' | 'pomodoro' | 'bujo' | 'health' | 'tareas' | 'habitos' | 'calendario' | 'documentos' | 'finanzas' | 'shopping' | 'proyectos' | 'actividad' | 'clientes' | 'estadisticas' | 'mensajes' | 'ajustes';
